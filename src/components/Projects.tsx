...
SECTION 3.2: COMPLETE FEATURE MATRIX & LEAKAGE AUDIT
==================================================
catalog_total_rows: 331437      decay_positive_count: 42299.0
...
const Tag = ({ children }: { children: React.ReactNode }) => (
  <span className="px-3 py-1 text-xs rounded-full border border-border bg-muted text-muted-foreground">
    {children}
  </span>
);
...
const Projects = () => {
  return (
    <section id="work" className="py-24 px-6 border-y border-border">
      <div className="max-w-5xl mx-auto space-y-8">
        <h2 className="text-3xl md:text-4xl font-display font-bold mb-12 tracking-tight">
          Featured Projects
        </h2>

        <article className="rounded-xl border border-border bg-card p-6 md:p-8 shadow-glow">
          <div className="flex flex-wrap items-center gap-3 mb-4">
            <Category>ML &amp; Data Engineering</Category>
            <Metric>Rule Agreement: 100.0%</Metric>
          </div>

          <h3 className="text-xl md:text-2xl font-display font-bold mb-4 tracking-tight">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            ...
            forward organic decay (T+1). Proved that standard linear correlation metrics fail to
            catch target leakage on heavy-tailed distributions because decay is a step-function
            threshold (&le; 80%). Implemented a deterministic rule-agreement check across 68,837
            active rows that isolated exact target contamination with 100.0% accuracy.
          </p>

          <div className="rounded-lg bg-code overflow-hidden mb-6">
            <pre className="p-4 text-xs md:text-sm overflow-x-auto text-code-foreground font-mono leading-relaxed">
              {terminalOutput}
            </pre>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            >
              <a
                href="https://github.com/Tokollo-server/flyrank-ml-internship/blob/main/work/notebooks/w03_data_contract.ipynb"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <article className="rounded-xl border border-border bg-card p-6 md:p-8 shadow-glow">
          <div className="flex flex-wrap items-center gap-3 mb-4">
            <Category>Prompt Engineering / AI Development</Category>
            <Metric>6-Stage Isolation Experiment</Metric>
          </div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            ...
            logic, and that a few-shot example altered error payload structures across the board
            while correctly preserving security status codes.
          </p>
        ...
        <article className="rounded-xl border border-border bg-card p-6 md:p-8 shadow-glow">
          <div className="flex flex-wrap items-center gap-3 mb-4">
            <Category>Full-Stack Web Development</Category>
            <Metric>Production MERN Stack</Metric>
          </div>
